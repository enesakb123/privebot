...
module.exports.run = async (bot, message, args) => {
    ...
    if(!message.member.hasPermission("BAN_MEMBERS")) return message.channel.send("Je hebt niet de juiste permissions");
    ...
    var anncementChannel = message.guild.channels.find(`name`, `mededeling`);
