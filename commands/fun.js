...
module.exports.run = async (bot, message, args) => {
    ...
    if(!message.member.hasPermission("SEND_MESSAGES")) return message.channel.send("Je Hebt Niet De Juiste Permissions, Vriend !").then(msg => msg.delete(10000));
        ...
        let BotEmbed = new Discord.RichEmbed()
            ...
            BotEmbed.setAuthor("Fun Module", "https://media.discordapp.net/attachments/717466556006793248/717472044547178526/95fa68627efaf312326ac6ae601d5cb2.gif")
	    BotEmbed.setThumbnail("https://media.discordapp.net/attachments/717466556006793248/717472044547178526/95fa68627efaf312326ac6ae601d5cb2.gif")
            BotEmbed.addField("**8Ball:**", "**-8ball**", true)
	    BotEmbed.addField("**Steen Papier Schaar:**", "**-steen papier schaar**", true)
            BotEmbed.addField("**Casino Gokken:**", "**-casino**", true)
